...
The same types of indicators are avaible than for automatic indicators, but this time functions starts with `use_*` and you have to explicitly trigger the indicator server-side.
